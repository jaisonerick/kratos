...
You must provision your server prior to execute the capistrano deployment task.
This setup is using the follow guidelines:

- The deployment server have a user called "deploy".
- The deployment folder is "/home/deploy/projectname"
